...
// FIXME: consider if this can become `ActiveContext` and include methods for:
// 1. processing types and properties
// 2. reverting
// 3. providing term information or at least mapping info
export class ContextProcessor {
  ...
  async applyPropertyScopedContext({
    activeCtx, contextStack, term
  }) {
    let propertyContextStack = contextStack;
