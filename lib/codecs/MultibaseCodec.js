...
export class MultibaseCodec {
  ...
  decodeCBOR() {
    ...
    if(encoding === 0x7a) { // 0x7a === 'z' (multibase code for base58btc)
      decodedValue = 'z' + b58.encode(this.value.slice(1));

    } else if(encoding === 'M') { // 0x4d === 'M' (multibase code for base64pad)
