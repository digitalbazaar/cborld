  ...
  static createEncoder({value, transformer} = {}) {
    ...
    if(parsed) {
      ...
      if(data === Base64.fromUint8Array(Base64.toUint8Array(data))) {
        return new DataUrlEncoder({value, base64: true, compressionMap: transformer.urlTable});
      }
    }
    return new DataUrlEncoder({value, base64: false, compressionMap: transformer.urlTable});
  }
}
