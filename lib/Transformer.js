...
export class Transformer {
  ...
  constructor({
    ...
    this.activeCtx = new ActiveContext({contextProcessor});
   ...
   */
  async _transform({activeCtx = this.activeCtx, obj, transformMap}) {
    ...
    // FIXME: update active context processing to just drop active contexts
    // after use, instead of calling revert on them
