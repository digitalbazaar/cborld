...
export class Transformer {
  ...
  constructor({
    ...
    // FIXME: remove
    if(stringTable && (true || !this.typeTable.has('context'))) {
      this.typeTable.set('context', stringTable);
    }
    if(stringTable && (true || !this.typeTable.has('url'))) {
      this.typeTable.set('url', stringTable);
    }
    if(stringTable && (true || !this.typeTable.has('none'))) {
      this.typeTable.set('none', stringTable);
    }
  }
