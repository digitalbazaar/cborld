 ...
 */
import {Base64PadCodec} from './codecs/Base64PadCodec';
    ...
    if(typeof value === 'string') {
      ...
      switch(value['@type']) {
        ...
        case 'xsd:dateTime':
          ...
          break;
          // FIXME: Keep track of prefixes and see if sec matches; consider
          // using jsonld.js to process context and get term definitions for
          // robustness
        case 'sec:base64Pad':
