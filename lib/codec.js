...
/**
 * Gets a term codec map for the given set of JSON-LD Context URLs. This map can be
 * used to perform compression or decompression.
 *
 ...
 *   dereferencing URLs.
 * @param {boolean} [args.encode] - If true, a map of term encoding codecs are
 *   returned.
 * @param {boolean} [args.decode] - If true, a map of term decoding codecs are
 *   returned.
 *
 * @returns {object} - The term codec map for performing compression/decompression.
 */
    ...
    if(typeof value === 'string') {
      ...
      switch(value['@type']) {
        ...
        case 'xsd:dateTime':
          ...
          break;
          // FIXME: Keep track of prefixes and see if sec matches; consider using
          // jsonld.js to process context and get term definitions for robusticity
